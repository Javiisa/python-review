...
# Alternativamente,podemos sumar directamente pasando el arreglo a la funciòn
...
print ("Direcciòn:", student["address"])
print("Promedio de notas", average)

#Si queremos sumar nùmeros enteros,tenemos una opciòn màs simple
#que es la funciòn sum()
